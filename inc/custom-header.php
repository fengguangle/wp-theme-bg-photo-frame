 ...
 *
 * @uses bg_photo_frame_header_style()
 ...
 *
 * @see bg_photo_frame_custom_header_setup().
 */
function bg_photo_frame_header_style() {
...
endif; // bg_photo_frame_header_style

if ( ! function_exists( 'bg_photo_frame_admin_header_style' ) ) :
/**
 * Styles the header image displayed on the Appearance > Header admin panel.
 *
 * @see bg_photo_frame_custom_header_setup().
 */
function bg_photo_frame_admin_header_style() {
?>
	<style type="text/css">
...
endif; // bg_photo_frame_admin_header_style

if ( ! function_exists( 'bg_photo_frame_admin_header_image' ) ) :
/**
 * Custom header image markup displayed on the Appearance > Header admin panel.
 *
 * @see bg_photo_frame_custom_header_setup().
 */
function bg_photo_frame_admin_header_image() {
?>
	<div id="headimg">
...
endif; // bg_photo_frame_admin_header_image
